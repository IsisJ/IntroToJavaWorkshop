...
public class code4Life {
	 ...
	 */
		String howManyHoursOfCode=JOptionPane.showInputDialog("How many hours did you spend coding this week?");
		int hoursOfCode= Integer.parseInt(howManyHoursOfCode);
		if(hoursOfCode>5){
			playBatmanTheme();
		}
		if(hoursOfCode>=3){
