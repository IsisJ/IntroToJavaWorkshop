...
int background = -14985384;
		//6. if the mouse falls off the path (if it is on the background)
		if (mouseColor==background){
		scare()	;
		JOptionPane.showMessageDialog(null, "Ha, did you see your face! You lost");
		}
	...
	if (mouseColor==-7459304) {
		JOptionPane.showMessageDialog(null, "You did it! You won!");
	}
	}
